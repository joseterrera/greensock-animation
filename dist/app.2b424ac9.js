...
},{"./helpers":74}],2:[function(require,module,exports) {
'use strict';
...
var main = function main(event) {
  ...
  function clearStage() {
    var clearTl = new _gsap.TimelineMax();
  ...
  function enterFloorVegetation() {
    var enterFloorVegetationTl = new _gsap.TimelineMax();
  ...
  var flowerDance = function flowerDance() {
    ...
    return new _gsap.TimelineMax({ repeat: -1, repeatDelay: 1 }).to(removeItems1, 1, { throwProps: { rotation: 360 } })
  ...
  function birdsEating() {
    var birdsEatingTl = new _gsap.TimelineMax({ repeat: -1, repeatDelay: 4 });
    birdsEatingTl
  ...
  function startBlinking() {
    ...
    var birdBlinksTl = new _gsap.TimelineMax({ repeat: -1, repeatDelay: 10 });
  ...
  function cloudsMoving() {
    var cloudsMovingTl = new _gsap.TimelineMax({ repeat: -1 }, Math.random() * 5);
  ...
  function bunnyInTheBack() {
    var bunnyInTheBackTl = new _gsap.TimelineMax();
  ...
  function go() {
    ...
    masterTl.add(clearStage(), 'scene-clear-stage').add(enterFloorVegetation(), 'scene-floor-vegetation')
    // .add(birdsEating(), "birds-eating")
    .add(cloudsMoving(), 'clouds-moving').add(flowerDance(), 0).add(bunnyInTheBack(), 'bunny-in-the-back');
  }
...
},{"gsap":6,"./js/lib/shuffle":70,"./js/lib/helpers":74,"./js/lib/selector":73}],81:[function(require,module,exports) {
